...
class BinarySearchTree:
    ...
    def __sorted_list_to_bst(
        ...
        root: Node = Node(nums[middle])

        root.left = self.__sorted_list_to_bst(nums, left, middle - 1)

        root.right = self.__sorted_list_to_bst(nums, middle + 1, right)
